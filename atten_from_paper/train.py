...
def _train_step(state: TrainState, batch: dict, rng: jax.Array) -> tuple[TrainState, jax.Array]:
    def loss_fn(params):
...
def _eval_step(state: TrainState, batch: dict, rng: jax.Array) -> jax.Array:
